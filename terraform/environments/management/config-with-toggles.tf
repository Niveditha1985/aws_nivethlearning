...
# ============================================================================
# NOTE: Can be disabled via var.enable_aws_config to save ~$9/month during testing

# S3 bucket for Config logs (always created, minimal cost)
...
# IAM role for AWS Config (always created)
...
# ============================================================================
# AWS Config Recorder - Can be disabled to save costs during testing
# ============================================================================
...
# ============================================================================
# AWS Config Rules - Each can be toggled individually
# ============================================================================
...
resource "aws_config_config_rule" "s3_bucket_public_read_prohibited" {
  count = var.enable_aws_config && var.enable_config_rule_s3_public_access ? 1 : 0
